...
- Task model: duration, work-hours-only, continue-next-day, deadlines,
...
- Full-screen schedule view: SVG Gantt with rich hover tooltips, a start/end
  details table, and self-contained single-file HTML export.
